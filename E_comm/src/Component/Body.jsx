...
import { Link, useNavigate, data } from "react-router-dom";
...
const Body = () => {
  ...
  const categories = [
    { name: "Resistor", icon: "📺" },
    { name: "Passive Components", icon: "🔊" },
    { name: "Semiconductors", icon: "🎧" },
    { name: "Switches", icon: "📱" },
    { name: "Audio Components", icon: "💻" },
    { name: "Motors", icon: "🎮" },
  ];
        ...
        <div className="container mx-auto flex justify-around items-center px-4">
          {categories.map((category, index) => (
            ...
            >
              ...
              <span className="text-gray-700 w-3/12 sm:w-auto overflow-hidden md:overflow-visible sm:font-medium">
                {category.name}
              </span>
            </div>
          ))}
        ...
        <div className="container mx-auto flex md:flex-row items-center px-4">
          ...
          <div className="md:w-1/2 space-y-4">
            ...
            <p className="text-2xl font-bold">
              From <span className="text-yellow-400">$499.99</span>
            </p>
